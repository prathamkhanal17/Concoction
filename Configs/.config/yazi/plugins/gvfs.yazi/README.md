...
prepend_keymap = [
    ...
    #       -> Every value within [] are optional; values within {} you need to choose only one of them; The rest are required.
    #       -> Example: {ftp,ftps,ftpis}://[user@]host[:port] => ftp://myusername@IP:PORT or ftps://myusername@github.com
    ...
    #           - Google Drive, One drive are mounted automatically via GNOME Online Accounts (GOA). Avoid adding them.
...
prepend_preloaders = [
  ...
  # For mounted for hard disk/drive
